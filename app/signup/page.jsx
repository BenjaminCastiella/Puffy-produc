      ...
      <div className="flex-1 flex items-center justify-center py-12">
        <div className="mx-auto grid w-full max-w-md gap-6 px-4">
          <div className="space-y-2 text-center">
            <h1 className="text-3xl font-bold text-puffy-brown">Crear una cuenta</h1>
            <p className="text-puffy-brown-dark text-sm">Ingresa tus datos para registrarte en Puffy</p>
          </div>
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="first-name" className="text-puffy-brown">
                  Nombre
                </Label>
                <Input id="first-name" placeholder="Juan" className="border-puffy-brown" required />
              </div>
              <div className="space-y-2">
                <Label htmlFor="last-name" className="text-puffy-brown">
                  Apellido
                </Label>
                <Input id="last-name" placeholder="Pérez" className="border-puffy-brown" required />
              </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="confirm-password" className="text-puffy-brown">
                Confirmar contraseña
              </Label>
              <Input id="confirm-password" type="password" className="border-puffy-brown" required />
            </div>
            <div className="flex items-center space-x-2">
              <Checkbox id="terms" required />
              <Label htmlFor="terms" className="text-xs text-puffy-brown-dark">
                Acepto los{" "}
                <Link href="#" className="text-puffy-brown hover:underline">
            ...
            <Button className="w-full bg-puffy-brown text-white hover:bg-puffy-brown-light">Crear cuenta</Button>
          </div>
          <div className="mt-4 text-center text-sm">
            <p className="text-puffy-brown-dark">
              ¿Ya tienes una cuenta?{" "}
              <Link href="/login" className="text-puffy-brown font-medium hover:underline">
                Inicia sesión
              </Link>
            </p>
          </div>
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-puffy-cream-light px-2 text-puffy-brown-dark">O regístrate con</span>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
